...
public class Prestamos extends JFrame{
    ...
    public void initComponents(){
       ...
       JLabel etq_interes = new JLabel();
        ...
        JLabel etq_titulos = new JLabel();
        etq_titulos.setText("Plan de Pagos: ");
        etq_titulos.setFont (new Font ("Arial", Font.BOLD, 20));
        etq_titulos.setHorizontalAlignment(JLabel.LEFT);
        restricciones.gridx = 0;
        ...
        contenedor.add(etq_titulos, restricciones);
        restricciones.insets = new Insets(0,0,0,0);
        ...
        ActionListener evento_calcular = new ActionListener(){
            public void actionPerformed(ActionEvent event){
                System.out.println("Clic en CALCULAR");
