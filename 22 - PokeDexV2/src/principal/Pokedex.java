...
public class Pokedex extends javax.swing.JFrame {
    ...
    public void cargarPaginador(){
       ...
       panelPaginador.add(btn_inicio);
       panelPaginador.add(btn_atras);
       
       for(int i = 1; i < listaNumeros.length; i++){
           JButton btn = new JButton("" + listaNumeros[i]);
            if (listaNumeros[i] == pagina) {
                btn.setEnabled(false); 
            }
            int page = listaNumeros[i];
        ...
        JButton btn_adelante = new JButton(">");
        JButton btn_final = new JButton(">>");
        ...
        panelPaginador.add(btn_adelante);
        panelPaginador.add(btn_final);
    ...
    private void Dataprueba(int page) {
        
        System.out.println("Datos de la página: " + page);
